...
namespace CalculateFunding.Services.Publishing.UnitTests.Reporting
{
    ...
    public class PublishedFundingFundingLineGroupingCsvTransformTests : FundingLineCsvTransformTestBase
    {
            ...
            CalculateFunding.Models.Publishing.GroupingReason expectedGroupingReason)
        {
            ...
            ExpandoObject[] transformProviderResultsIntoCsvRows = _transformation.Transform(new [] { publishedFunding }, FundingLineCsvGeneratorJobType.CurrentOrganisationGroupValues).ToArray();
