...
{
    [TestClass]
    public class PublishedFundingFundingLineGroupingCsvTransformTests : FundingLineCsvTransformTestBase
    {
        private PublishedFundingFundingLineGroupingCsvTransform _transformation;

        [TestInitialize]
        public void SetUp()
        {
            _transformation = new PublishedFundingFundingLineGroupingCsvTransform();
        }
            ...
            CalculateFunding.Models.Publishing.GroupingReason expectedGroupingReason)
        {
            ...
            ExpandoObject[] transformProviderResultsIntoCsvRows = _transformation.Transform(new [] { publishedFunding }, FundingLineCsvGeneratorJobType.CurrentOrganisationGroupValues, null).ToArray();
