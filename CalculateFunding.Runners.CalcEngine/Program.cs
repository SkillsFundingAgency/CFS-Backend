...
namespace CalculateFunding.Runners.CalcEngine
{
    ...
    {
        private const string ServiceName = "CalculateFunding.Runners.CalcEngine";
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                {
                    RegisterComponents(services, (IConfigurationRoot)context.Configuration);
                })
        ...
        private static void RegisterComponents(IServiceCollection builder, IConfigurationRoot config)
        {
            ...
            builder.AddApplicationInsightsTelemetryClient(config, ServiceName);
            builder.AddApplicationInsightsServiceName(config, ServiceName);

            builder.AddLogging(ServiceName, config);
            ...
            builder.AddHostedService<OnCalcsGenerateAllocationResults>();
        }
