...
namespace CalculateFunding.Services.Publishing.FundingManagement.Interfaces
{
    public interface IReleaseManagementRepository
    {
        ...
        Task<IEnumerable<PublishedFundingChannelVersion>> GetChannelPublishedFundingGroupsForSpecificationId(string specificationId);
        ...
        Task ClearDatabase();
        Task<bool> DatabaseHasExistingFundingData(IEnumerable<string> fundingStreamIds, string fundingPeriodId);
