...
{
    public abstract class BasePublishedProviderStateCsvGenerator : JobProcessingService, IPublishedProviderEstateCsvGenerator, IPublishedProviderStateSummaryCsvGenerator, IHealthChecker
    {
        ...
        private readonly IPublishedProviderStateSummaryCsvTransformServiceLocator _publishedProviderStateSummaryCsvTransformServiceLocator;

        protected abstract string JobDefinitionName { get; }

        protected BasePublishedProviderStateCsvGenerator(
            ...
            IPublishedProviderStateSummaryCsvTransformServiceLocator publishedProviderStateSummaryCsvTransformServiceLocator) : base(jobManagement, logger)
        {
            ...
            Guard.ArgumentNotNull(publishedProviderStateSummaryCsvTransformServiceLocator, nameof(publishedProviderStateSummaryCsvTransformServiceLocator));
            ...
            _publishedProviderStateSummaryCsvTransformServiceLocator = publishedProviderStateSummaryCsvTransformServiceLocator;
            _logger = logger;
        }
        ...
        public override async Task Process(Message message)
        {
            ...
            IPublishedProviderStateSummaryCsvTransform publishedProviderStateSummaryCsvTransform = _publishedProviderStateSummaryCsvTransformServiceLocator.GetService(JobDefinitionName);
            bool processedResults = await GenerateCsv(message, temporaryFilePath, publishedProviderStateSummaryCsvTransform);
        ...
        protected abstract Task<bool> GenerateCsv(Message message, string temporaryFilePath, IPublishedProviderStateSummaryCsvTransform publishedProviderCsvTransform);
