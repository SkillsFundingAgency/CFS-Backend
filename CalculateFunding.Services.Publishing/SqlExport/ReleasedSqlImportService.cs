...
{
    public class ReleasedSqlImportService : JobProcessingService, IReleasedSqlImportService
    {
        ...
        public ReleasedSqlImportService(ISqlImporter import, 
            ...
            string correlationId)
        {
            ...
            {
                JobDefinitionId = RunReleasedSqlImportJob,
