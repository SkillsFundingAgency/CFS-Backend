...
{
    [TestClass]
    public class PublishedProviderContentsGeneratorTests : FundingSchema11TestBase
    {
        ...
        public void GeneratesJsonConformingToThe11Schema()
        {
            ...
            string publishedProviderExample = GetEmbeddedFileContents("published_provider_example_1.1.json");
