...
namespace CalculateFunding.Functions.Scenarios.ServiceBus
{
    public class OnEditSpecificationEvent : Retriable
    {
        ...
        public OnEditSpecificationEvent(
            ...
            : base(logger, messengerService, FunctionName, $"{ServiceBusConstants.TopicNames.EditSpecification}/{ServiceBusConstants.TopicSubscribers.UpdateScenariosForEditSpecification}", useAzureStorage, userProfileProvider, scenariosService, refresherProvider)
        {
        }
