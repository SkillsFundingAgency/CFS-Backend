...
#line 122
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                    "G-002\'", ((string)(null)), table125, "And ");
#line hidden
...
#line 126
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                    "g line \'DSG-002\'", ((string)(null)), table126, "And ");
#line hidden
...
#line 130
 testRunner.And("template mapping exists", ((string)(null)), table127, "And ");
#line hidden
...
#line hidden
            ...
            table140.AddRow(new string[] {
                        ...
                        string.Format("{0}", fundingStreamId)});
#line 942
 testRunner.Then("the following published funding is produced", ((string)(null)), table140, "Then ");
#line 949
...
#line 950
 testRunner.And("the published funding contains the following published provider ids", ((string)(null)), table141, "And ");
#line 954
...
#line 956
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                    "th id of \'FY-1920\' has the following profiles", ((string)(null)), table142, "And ");
#line hidden
...
#line 959
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                    "th id of \'FY-2021\' has the following profiles", ((string)(null)), table143, "And ");
#line hidden
...
#line 962
 testRunner.And("the published funding contains a calculations in published provider with followin" +
                    "g calculation results", ((string)(null)), table144, "And ");
#line hidden
...
#line 1074
 testRunner.And("the published funding document produced is saved to blob storage for following fi" +
                    "le name", ((string)(null)), table145, "And ");
#line hidden
...
#line 1078
 testRunner.And("the published provider document produced is saved to blob storage for following f" +
                    "ile name", ((string)(null)), table146, "And ");
#line hidden
...
#line 1082
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                        "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table147, "And ");
#line hidden
