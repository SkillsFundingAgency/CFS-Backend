...
namespace CalculateFunding.Publishing.AcceptanceTests.Features.PublishFunding
{
    ...
    public partial class PublishingBatchFundingDsgFeature
    {
...
#line 1 "PublishingBatchFundingDsg.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/PublishFunding", "PublishingBatchFundingDsg", "\tIn order to publish funding for Dedicated Schools Grant\r\n\tAs a funding approvder" +
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "PublishingBatchFundingDsg")))
            {
                global::CalculateFunding.Publishing.AcceptanceTests.Features.PublishFunding.PublishingBatchFundingDsgFeature.FeatureSetup(null);
            }
        }
...
#line hidden
            ...
            else
            {
                ...
                table593.AddRow(new string[] {
                            ...
                            "1.0"});
#line 8
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table593, "Given ");
#line hidden
                ...
                table594.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 11
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table594, "And ");
#line hidden
#line 17
...
#line hidden
                ...
                table595.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 18
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table595, "And ");
#line hidden
#line 24
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 25
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table596, "And ");
#line hidden
#line 31
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 32
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table597, "And ");
#line hidden
#line 38
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table598.AddRow(new string[] {
                            ...
                            "Country"});
#line 39
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table598, "And ");
#line hidden
#line 45
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table599.AddRow(new string[] {
                            ...
                            "FY"});
#line 46
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table599, "And ");
#line hidden
...
#line 54
 testRunner.And("the following specification exists", ((string)(null)), table600, "And ");
#line hidden
#line 60
...
#line 61
 testRunner.And("the specification has the following funding streams", ((string)(null)), table601, "And ");
#line hidden
                ...
                table602.AddRow(new string[] {
                            ...
                            "1.0"});
#line 64
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table602, "And ");
#line hidden
                ...
                table603.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 67
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table603, "And ");
#line hidden
                ...
                table604.AddRow(new string[] {
                            ...
                            ""});
#line 72
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table604, "And ");
#line hidden
#line 78
...
#line hidden
                ...
                table605.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 79
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table605, "And ");
#line hidden
...
#line 90
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table606, "And ");
#line hidden
                ...
                table607.AddRow(new string[] {
                            ...
                            "Payment"});
#line 100
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table607, "And ");
#line hidden
...
#line 123
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table608, "And ");
#line hidden
...
#line 127
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table609, "And ");
#line hidden
...
#line 131
 testRunner.And("template mapping exists", ((string)(null)), table610, "And ");
#line hidden
                ...
                table611.AddRow(new string[] {
                            ...
                            "320"});
#line 305
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table611, "And ");
#line hidden
                ...
                table612.AddRow(new string[] {
                            ...
                            "1000000"});
#line 479
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table612, "And ");
#line hidden
#line 492
...
#line 494
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table613, "And ");
#line hidden
#line 507
...
#line 541
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table616, "And ");
#line hidden
...
#line 545
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table617, "And ");
#line hidden
...
#line 738
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table620, "And ");
#line hidden
#line 751
...
#line 753
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table621, "And ");
#line hidden
...
#line 940
 testRunner.When("batch funding is published", ((string)(null)), table623, "When ");
#line hidden
                ...
                table624.AddRow(new string[] {
                            ...
                            string.Format("{0}", fundingStreamId)});
#line 943
 testRunner.Then("the following published funding is produced", ((string)(null)), table624, "Then ");
#line hidden
#line 950
...
#line 951
 testRunner.And("the published funding contains the following published provider ids", ((string)(null)), table625, "And ");
#line hidden
#line 955
...
#line 957
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-1920\' has the following profiles", ((string)(null)), table626, "And ");
#line hidden
...
#line 960
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-2021\' has the following profiles", ((string)(null)), table627, "And ");
#line hidden
...
#line 963
 testRunner.And("the published funding contains a calculations in published provider with followin" +
                        "g calculation results", ((string)(null)), table628, "And ");
#line hidden
...
#line 1075
 testRunner.And("the published funding document produced is saved to blob storage for following fi" +
                        "le name", ((string)(null)), table629, "And ");
#line hidden
                ...
                table630.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1079
 testRunner.And("the published funding document produced has following metadata", ((string)(null)), table630, "And ");
#line hidden
...
#line 1083
 testRunner.And("the published provider document produced is saved to blob storage for following f" +
                        "ile name", ((string)(null)), table631, "And ");
#line hidden
                ...
                table632.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1086
 testRunner.And("the published provider document produced has following metadata", ((string)(null)), table632, "And ");
#line hidden
...
#line 1089
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table633, "And ");
#line hidden
                ...
                table634.AddRow(new string[] {
                            ...
                            ""});
#line 1092
 testRunner.And("the following job is requested is completed for the current specification", ((string)(null)), table634, "And ");
#line hidden
                ...
                table635.AddRow(new string[] {
                            ...
                            "Released"});
#line 1098
 testRunner.And("the following released published provider ids are upserted", ((string)(null)), table635, "And ");
#line hidden
            }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "PublishingBatchFundingDsg")]
