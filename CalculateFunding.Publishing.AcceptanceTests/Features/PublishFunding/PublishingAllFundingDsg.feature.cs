...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/PublishFunding", "PublishingAllFundingDsg", "\tIn order to publish funding for Dedicated Schools Grant\r\n\tAs a funding approvder" +
        ...
        public virtual void TestInitialize()
        {
            ...
            {
                global::CalculateFunding.Publishing.AcceptanceTests.Features.PublishFunding.PublishingAllFundingDsgFeature.FeatureSetup(null);
            }
        }
...
#line hidden
            ...
            else
            {
                ...
                table368.AddRow(new string[] {
                            ...
                            "1.0"});
#line 8
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table368, "Given ");
#line hidden
...
#line hidden
                ...
                table374.AddRow(new string[] {
                            ...
                            "FY"});
#line 46
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table374, "And ");
#line hidden
...
#line 54
 testRunner.And("the following specification exists", ((string)(null)), table375, "And ");
#line hidden
#line 60
...
#line 61
 testRunner.And("the specification has the following funding streams", ((string)(null)), table376, "And ");
#line hidden
                ...
                table377.AddRow(new string[] {
                            ...
                            "1.0"});
#line 64
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table377, "And ");
#line hidden
                ...
                table378.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 67
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table378, "And ");
#line hidden
                ...
                table379.AddRow(new string[] {
                            ...
                            ""});
#line 72
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table379, "And ");
#line hidden
#line 78
...
#line hidden
                ...
                table380.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 79
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table380, "And ");
#line hidden
...
#line 90
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table381, "And ");
#line hidden
                ...
                table382.AddRow(new string[] {
                            ...
                            "Payment"});
#line 100
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table382, "And ");
#line hidden
...
#line 123
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table383, "And ");
#line hidden
...
#line 127
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table384, "And ");
#line hidden
...
#line 131
 testRunner.And("template mapping exists", ((string)(null)), table385, "And ");
#line hidden
...
#line 495
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table388, "And ");
#line hidden
#line 508
...
#line 509
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table389, "And ");
#line hidden
                ...
                table390.AddRow(new string[] {
                            ...
                            "Payment"});
#line 519
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table390, "And ");
#line hidden
...
#line 542
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table391, "And ");
#line hidden
...
#line 546
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table392, "And ");
#line hidden
                ...
                table393.AddRow(new string[] {
                            ...
                            "320"});
#line 550
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table393, "And ");
#line hidden
                ...
                table394.AddRow(new string[] {
                            ...
                            "1000002"});
#line 724
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table394, "And ");
#line hidden
#line 737
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 739
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table395, "And ");
#line hidden
#line 753
...
#line 755
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table396, "And ");
#line hidden
                ...
                table397.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 768
 testRunner.And("calculations exists", ((string)(null)), table397, "And ");
#line hidden
#line 942
...
#line hidden
                ...
                table398.AddRow(new string[] {
                            ...
                            string.Format("{0}", fundingStreamId)});
#line 943
 testRunner.Then("the following published funding is produced", ((string)(null)), table398, "Then ");
#line hidden
#line 950
...
#line 951
 testRunner.And("the published funding contains the following published provider ids", ((string)(null)), table399, "And ");
#line hidden
#line 955
...
#line 957
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-1920\' has the following profiles", ((string)(null)), table400, "And ");
#line hidden
...
#line 960
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-2021\' has the following profiles", ((string)(null)), table401, "And ");
#line hidden
...
#line 963
 testRunner.And("the published funding contains a calculations in published provider with followin" +
                        "g calculation results", ((string)(null)), table402, "And ");
#line hidden
...
#line 1075
 testRunner.And("the published funding document produced is saved to blob storage for following fi" +
                        "le name", ((string)(null)), table403, "And ");
#line hidden
                ...
                table404.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1079
 testRunner.And("the published funding document produced has following metadata", ((string)(null)), table404, "And ");
#line hidden
...
#line 1083
 testRunner.And("the published provider document produced is saved to blob storage for following f" +
                        "ile name", ((string)(null)), table405, "And ");
#line hidden
                ...
                table406.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1087
 testRunner.And("the published provider document produced has following metadata", ((string)(null)), table406, "And ");
#line hidden
...
#line 1091
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table407, "And ");
#line hidden
                ...
                table408.AddRow(new string[] {
                            ...
                            ""});
#line 1095
 testRunner.And("the following job is requested is completed for the current specification", ((string)(null)), table408, "And ");
#line hidden
                ...
                table409.AddRow(new string[] {
                            ...
                            "Released"});
#line 1101
 testRunner.And("the following released published provider ids are upserted", ((string)(null)), table409, "And ");
#line hidden
                ...
                table410.AddRow(new string[] {
                            ...
                            "ProfilingUpdated"});
#line 1105
 testRunner.And("the provider variation reasons were recorded", ((string)(null)), table410, "And ");
#line hidden
            }
