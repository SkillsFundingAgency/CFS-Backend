...
#line 124
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                    "g line \'DSG-002\'", ((string)(null)), table17, "And ");
#line hidden
            ...
            table18.AddRow(new string[] {
                        ...
                        "320"});
#line 128
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table18, "And ");
#line hidden
            ...
            table19.AddRow(new string[] {
                        ...
                        ""});
#line 292
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table19, "And ");
#line 343
...
#line 345
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                        "", providerVersionId), ((string)(null)), table20, "And ");
#line 396
...
#line 432
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                    "g line \'DSG-002\'", ((string)(null)), table24, "And ");
#line hidden
...
#line hidden
            ...
            table26.AddRow(new string[] {
                        ...
                        ""});
#line 600
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table26, "And ");
#line 651
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 653
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                        "", providerVersionId), ((string)(null)), table27, "And ");
#line 704
...
#line 757
 testRunner.And("template mapping exists", ((string)(null)), table29, "And ");
#line hidden
...
#line hidden
            ...
            table31.AddRow(new string[] {
                        ...
                        "Approved"});
#line 1098
 testRunner.And("the following published provider ids are upserted", ((string)(null)), table31, "And ");
#line hidden
