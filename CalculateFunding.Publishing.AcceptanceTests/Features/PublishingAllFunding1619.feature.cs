...
#line hidden
            ...
            else
            {
                ...
                table315.AddRow(new string[] {
                            ...
                            "1.0"});
#line 7
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table315, "Given ");
#line hidden
                ...
                table316.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 10
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table316, "And ");
#line hidden
#line 16
...
#line hidden
                ...
                table317.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 17
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table317, "And ");
#line hidden
#line 23
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 31
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table319, "And ");
#line hidden
#line 37
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table321.AddRow(new string[] {
                            ...
                            "AS"});
#line 45
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table321, "And ");
#line hidden
...
#line 53
 testRunner.And("the following specification exists", ((string)(null)), table322, "And ");
#line hidden
#line 59
...
#line 60
 testRunner.And("the specification has the following funding streams", ((string)(null)), table323, "And ");
#line hidden
                ...
                table324.AddRow(new string[] {
                            ...
                            "1.0"});
#line 63
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table324, "And ");
#line hidden
                ...
                table325.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 66
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table325, "And ");
#line hidden
                ...
                table326.AddRow(new string[] {
                            ...
                            ""});
#line 71
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table326, "And ");
#line hidden
#line 77
...
#line hidden
                ...
                table327.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 78
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table327, "And ");
#line hidden
...
#line 89
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table328, "And ");
#line hidden
                ...
                table329.AddRow(new string[] {
                            ...
                            "Payment"});
#line 99
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table329, "And ");
#line hidden
...
#line 122
 testRunner.And("the Published Provider has the following distribution period for funding line \'16" +
                        "19-002\'", ((string)(null)), table330, "And ");
#line hidden
...
#line 126
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'1619-002\'", ((string)(null)), table331, "And ");
#line hidden
...
#line 130
 testRunner.And("template mapping exists", ((string)(null)), table332, "And ");
#line hidden
                ...
                table333.AddRow(new string[] {
                            ...
                            "320"});
#line 305
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table333, "And ");
#line hidden
                ...
                table334.AddRow(new string[] {
                            ...
                            "1000000"});
#line 479
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table334, "And ");
#line hidden
#line 492
...
#line 494
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table335, "And ");
#line hidden
#line 507
...
#line 508
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table336, "And ");
#line hidden
                ...
                table337.AddRow(new string[] {
                            ...
                            "Payment"});
#line 518
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table337, "And ");
#line hidden
...
#line 541
 testRunner.And("the Published Provider has the following distribution period for funding line \'16" +
                        "19-002\'", ((string)(null)), table338, "And ");
#line hidden
...
#line 545
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'1619-002\'", ((string)(null)), table339, "And ");
#line hidden
...
#line 738
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table342, "And ");
#line hidden
#line 752
...
#line 754
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table343, "And ");
#line hidden
                ...
                table344.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 767
 testRunner.And("calculations exists", ((string)(null)), table344, "And ");
#line hidden
#line 941
...
#line hidden
                ...
                table345.AddRow(new string[] {
                            ...
                            string.Format("{0}", fundingStreamId)});
#line 942
 testRunner.Then("the following published funding is produced", ((string)(null)), table345, "Then ");
#line hidden
#line 949
...
#line 950
 testRunner.And("the published funding contains the following published provider ids", ((string)(null)), table346, "And ");
#line hidden
#line 954
...
#line 956
 testRunner.And("the published funding contains a distribution period in funding line \'1619-002\' w" +
                        "ith id of \'AS-1920\' has the following profiles", ((string)(null)), table347, "And ");
#line hidden
...
#line 959
 testRunner.And("the published funding contains a distribution period in funding line \'1619-002\' w" +
                        "ith id of \'AS-2021\' has the following profiles", ((string)(null)), table348, "And ");
#line hidden
...
#line 962
 testRunner.And("the published funding contains a calculations in published provider with followin" +
                        "g calculation results", ((string)(null)), table349, "And ");
#line hidden
...
#line 1074
 testRunner.And("the published funding document produced is saved to blob storage for following fi" +
                        "le name", ((string)(null)), table350, "And ");
#line hidden
                ...
                table351.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1078
 testRunner.And("the published funding document produced has following metadata", ((string)(null)), table351, "And ");
#line hidden
...
#line 1082
 testRunner.And("the published provider document produced is saved to blob storage for following f" +
                        "ile name", ((string)(null)), table352, "And ");
#line hidden
                ...
                table353.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1086
 testRunner.And("the published provider document produced has following metadata", ((string)(null)), table353, "And ");
#line hidden
...
#line 1090
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table354, "And ");
#line hidden
                ...
                table355.AddRow(new string[] {
                            ...
                            ""});
#line 1094
 testRunner.And("the following job is requested is completed for the current specification", ((string)(null)), table355, "And ");
#line hidden
                ...
                table356.AddRow(new string[] {
                            ...
                            "Released"});
#line 1100
 testRunner.And("the following released published provider ids are upserted", ((string)(null)), table356, "And ");
#line hidden
                ...
                table357.AddRow(new string[] {
                            ...
                            "ProfilingUpdated"});
#line 1104
 testRunner.And("the provider variation reasons were recorded", ((string)(null)), table357, "And ");
#line hidden
            }
