...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Approve", "ApproveAllFundingDsg", "\tIn order to approve funding for DSG\r\n\tAs a funding approver\r\n\tI want to approve " +
        ...
        public virtual void TestInitialize()
        {
            ...
            {
                global::CalculateFunding.Publishing.AcceptanceTests.Features.Approve.ApproveAllFundingDsgFeature.FeatureSetup(null);
            }
        }
...
#line hidden
            ...
            else
            {
                ...
                table20.AddRow(new string[] {
                            ...
                            "1.0"});
#line 8
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table20, "Given ");
#line hidden
...
#line 11
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table21, "And ");
#line hidden
#line 17
...
#line 18
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table22, "And ");
#line hidden
#line 24
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 25
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table23, "And ");
#line hidden
#line 31
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 32
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table24, "And ");
#line hidden
#line 38
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 39
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table25, "And ");
#line hidden
#line 45
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table26.AddRow(new string[] {
                            ...
                            "FY"});
#line 46
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table26, "And ");
#line hidden
...
#line 54
 testRunner.And("the following specification exists", ((string)(null)), table27, "And ");
#line hidden
#line 60
...
#line 61
 testRunner.And("the specification has the following funding streams", ((string)(null)), table28, "And ");
#line hidden
                ...
                table29.AddRow(new string[] {
                            ...
                            "1.0"});
#line 64
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table29, "And ");
#line hidden
                ...
                table30.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 67
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table30, "And ");
#line hidden
                ...
                table31.AddRow(new string[] {
                            ...
                            ""});
#line 72
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table31, "And ");
#line hidden
#line 78
...
#line hidden
                ...
                table32.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 79
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table32, "And ");
#line hidden
...
#line 89
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table33, "And ");
#line hidden
                ...
                table34.AddRow(new string[] {
                            ...
                            "Payment"});
#line 100
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table34, "And ");
#line hidden
...
#line 121
 testRunner.And("template mapping exists", ((string)(null)), table35, "And ");
#line hidden
...
#line 289
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table37, "And ");
#line hidden
...
#line 562
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table41, "And ");
#line hidden
                ...
                table42.AddRow(new string[] {
                            ...
                            "Payment"});
#line 572
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table42, "And ");
#line hidden
...
#line 597
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table44, "And ");
#line hidden
                ...
                table45.AddRow(new string[] {
                            ...
                            "320"});
#line 601
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table45, "And ");
#line hidden
                ...
                table46.AddRow(new string[] {
                            ...
                            ""});
#line 765
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table46, "And ");
#line hidden
#line 816
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table49.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 922
 testRunner.And("calculations exists", ((string)(null)), table49, "And ");
#line hidden
#line 1096
...
#line hidden
                ...
                table50.AddRow(new string[] {
                            ...
                            "Approved"});
#line 1097
 testRunner.Then("the following published provider ids are upserted", ((string)(null)), table50, "Then ");
#line hidden
...
#line 1101
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table51, "And ");
#line hidden
            }
