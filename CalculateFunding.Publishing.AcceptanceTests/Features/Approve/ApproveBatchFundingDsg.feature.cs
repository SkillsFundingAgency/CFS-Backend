...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Approve", "ApproveBatchFundingDsg", "\tIn order to approve funding for DSG\r\n\tAs a funding approver\r\n\tI want to approve " +
        ...
        public virtual void TestInitialize()
        {
            ...
            {
                global::CalculateFunding.Publishing.AcceptanceTests.Features.Approve.ApproveBatchFundingDsgFeature.FeatureSetup(null);
            }
        }
...
#line hidden
            ...
            else
            {
                ...
                table179.AddRow(new string[] {
                            ...
                            "1.0"});
#line 8
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table179, "Given ");
#line hidden
...
#line 11
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table180, "And ");
#line hidden
#line 17
...
#line 18
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table181, "And ");
#line hidden
#line 24
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 25
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table182, "And ");
#line hidden
#line 31
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 32
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table183, "And ");
#line hidden
#line 38
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 39
 testRunner.And("the funding configuration has the following organisation group and provider statu" +
                        "s list \'Open;Open, but proposed to close\'", ((string)(null)), table184, "And ");
#line hidden
#line 45
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table185.AddRow(new string[] {
                            ...
                            "FY"});
#line 46
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table185, "And ");
#line hidden
...
#line 54
 testRunner.And("the following specification exists", ((string)(null)), table186, "And ");
#line hidden
#line 60
...
#line 61
 testRunner.And("the specification has the following funding streams", ((string)(null)), table187, "And ");
#line hidden
                ...
                table188.AddRow(new string[] {
                            ...
                            "1.0"});
#line 64
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table188, "And ");
#line hidden
                ...
                table189.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 67
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table189, "And ");
#line hidden
                ...
                table190.AddRow(new string[] {
                            ...
                            ""});
#line 72
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table190, "And ");
#line hidden
#line 78
...
#line hidden
                ...
                table191.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 79
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table191, "And ");
#line hidden
...
#line 121
 testRunner.And("template mapping exists", ((string)(null)), table194, "And ");
#line hidden
...
#line 285
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table195, "And ");
#line hidden
...
#line 289
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table196, "And ");
#line hidden
                ...
                table197.AddRow(new string[] {
                            ...
                            "320"});
#line 293
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table197, "And ");
#line hidden
                ...
                table198.AddRow(new string[] {
                            ...
                            ""});
#line 457
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table198, "And ");
#line hidden
#line 508
...
#line 562
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table200, "And ");
#line hidden
                ...
                table201.AddRow(new string[] {
                            ...
                            "Payment"});
#line 572
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table201, "And ");
#line hidden
...
#line 593
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table202, "And ");
#line hidden
...
#line 597
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table203, "And ");
#line hidden
                ...
                table204.AddRow(new string[] {
                            ...
                            "320"});
#line 601
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table204, "And ");
#line hidden
                ...
                table205.AddRow(new string[] {
                            ...
                            ""});
#line 765
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table205, "And ");
#line hidden
#line 816
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table208.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 922
 testRunner.And("calculations exists", ((string)(null)), table208, "And ");
#line hidden
                ...
                table209.AddRow(new string[] {
                            "1000002"});
#line 1096
 testRunner.When("partial funding is approved", ((string)(null)), table209, "When ");
#line hidden
                ...
                table210.AddRow(new string[] {
                            ...
                            "Approved"});
#line 1099
 testRunner.Then("the following published provider ids are upserted", ((string)(null)), table210, "Then ");
#line hidden
...
#line 1103
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table211, "And ");
#line hidden
            }
