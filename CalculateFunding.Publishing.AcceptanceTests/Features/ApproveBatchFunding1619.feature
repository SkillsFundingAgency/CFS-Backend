Feature: ApproveBatchFunding1619
...
Scenario Outline: Successful approve of funding
	...
	And the Published Provider has the following funding lines
		...
		| Total DSG before deductions and recoupment           | 1619-001         | 3840  | 2              | Information |
	...
	And the following published provider search index items is produced for providerid with '<FundingStreamId>' and '<FundingPeriodId>'
		...
		| 1619-AS-2021-1000002 | LA maintained schools | Community school | Local Authority 1 | Approved      | Maintained School 2 | 1000002 | 12000        | specForPublishing | <FundingStreamId> | <FundingPeriodId> | 123456 | 1234567 | |
