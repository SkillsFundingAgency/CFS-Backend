...
#line hidden
            ...
            else
            {
                ...
                table478.AddRow(new string[] {
                            ...
                            "1.0"});
#line 7
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table478, "Given ");
#line hidden
                ...
                table479.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 10
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table479, "And ");
#line hidden
#line 16
...
#line hidden
                ...
                table480.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 17
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table480, "And ");
#line hidden
#line 23
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table484.AddRow(new string[] {
                            ...
                            "FY"});
#line 45
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table484, "And ");
#line hidden
...
#line 53
 testRunner.And("the following specification exists", ((string)(null)), table485, "And ");
#line hidden
#line 59
...
#line 60
 testRunner.And("the specification has the following funding streams", ((string)(null)), table486, "And ");
#line hidden
                ...
                table487.AddRow(new string[] {
                            ...
                            "1.0"});
#line 63
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table487, "And ");
#line hidden
                ...
                table488.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 66
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table488, "And ");
#line hidden
                ...
                table489.AddRow(new string[] {
                            ...
                            ""});
#line 71
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table489, "And ");
#line hidden
#line 77
...
#line hidden
                ...
                table490.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 78
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table490, "And ");
#line hidden
...
#line 120
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table493, "And ");
#line hidden
...
#line 124
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table494, "And ");
#line hidden
...
#line 128
 testRunner.And("template mapping exists", ((string)(null)), table495, "And ");
#line hidden
                ...
                table496.AddRow(new string[] {
                            ...
                            "320"});
#line 303
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table496, "And ");
#line hidden
                ...
                table497.AddRow(new string[] {
                            ...
                            "1000000"});
#line 477
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table497, "And ");
#line hidden
#line 490
...
#line 506
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table499, "And ");
#line hidden
                ...
                table500.AddRow(new string[] {
                            ...
                            "Payment"});
#line 516
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table500, "And ");
#line hidden
...
#line 537
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table501, "And ");
#line hidden
...
#line 541
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table502, "And ");
#line hidden
                ...
                table503.AddRow(new string[] {
                            ...
                            "320"});
#line 545
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table503, "And ");
#line hidden
                ...
                table504.AddRow(new string[] {
                            ...
                            "1000002"});
#line 719
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table504, "And ");
#line hidden
#line 732
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table507.AddRow(new string[] {
                            ...
                            "Approved"});
#line 762
 testRunner.And(string.Format("calculation meta data exists for \'{0}\'", fundingStreamId), ((string)(null)), table507, "And ");
#line hidden
                ...
                table508.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 936
 testRunner.And("calculations exists", ((string)(null)), table508, "And ");
#line hidden
                ...
                table509.AddRow(new string[] {
                            ...
                            "2000"});
#line 1110
 testRunner.And("the following distribution periods exist", ((string)(null)), table509, "And ");
#line hidden
                ...
                table510.AddRow(new string[] {
                            ...
                            "2000"});
#line 1114
 testRunner.And("the following profiles exist", ((string)(null)), table510, "And ");
#line hidden
#line 1118
...
#line hidden
                ...
                table511.AddRow(new string[] {
                            ...
                            "Updated"});
#line 1119
 testRunner.Then("the following published provider ids are upserted", ((string)(null)), table511, "Then ");
#line hidden
            }
