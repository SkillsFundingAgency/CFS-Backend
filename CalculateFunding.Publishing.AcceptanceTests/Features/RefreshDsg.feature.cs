...
#line hidden
            ...
            table242.AddRow(new string[] {
                        ...
                        "1.0"});
#line 7
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table242, "Given ");
#line hidden
            ...
            table243.AddRow(new string[] {
                        ...
                        "LocalAuthority"});
#line 10
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table243, "And ");
#line 16
...
#line 24
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table245, "And ");
#line 30
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 31
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table246, "And ");
#line 37
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            ...
            table247.AddRow(new string[] {
                        ...
                        "Country"});
#line 38
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table247, "And ");
#line 44
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            ...
            table248.AddRow(new string[] {
                        ...
                        "FY"});
#line 45
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table248, "And ");
#line hidden
...
#line 53
 testRunner.And("the following specification exists", ((string)(null)), table249, "And ");
#line 59
...
#line 60
 testRunner.And("the specification has the following funding streams", ((string)(null)), table250, "And ");
#line hidden
            ...
            table251.AddRow(new string[] {
                        ...
                        "1.0"});
#line 63
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table251, "And ");
#line hidden
            ...
            table252.AddRow(new string[] {
                        ...
                        "2019-09-29 00:00:00"});
#line 66
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table252, "And ");
#line hidden
            ...
            table253.AddRow(new string[] {
                        ...
                        ""});
#line 71
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table253, "And ");
#line 77
...
#line hidden
            ...
            table254.AddRow(new string[] {
                        ...
                        "2019-12-11 00:00"});
#line 78
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table254, "And ");
#line hidden
...
#line 88
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                    "ecification", ((string)(null)), table255, "And ");
#line hidden
            ...
            table256.AddRow(new string[] {
                        ...
                        "Payment"});
#line 99
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table256, "And ");
#line hidden
...
#line 120
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                    "G-002\'", ((string)(null)), table257, "And ");
#line hidden
...
#line 124
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                    "g line \'DSG-002\'", ((string)(null)), table258, "And ");
#line hidden
...
#line 128
 testRunner.And("template mapping exists", ((string)(null)), table259, "And ");
#line hidden
            ...
            table260.AddRow(new string[] {
                        ...
                        "320"});
#line 303
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table260, "And ");
#line hidden
            ...
            table261.AddRow(new string[] {
                        ...
                        "1000000"});
#line 477
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table261, "And ");
#line 490
...
#line 506
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                    "ecification", ((string)(null)), table263, "And ");
#line hidden
            ...
            table264.AddRow(new string[] {
                        ...
                        "Payment"});
#line 516
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table264, "And ");
#line hidden
...
#line 537
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                    "G-002\'", ((string)(null)), table265, "And ");
#line hidden
...
#line 541
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                    "g line \'DSG-002\'", ((string)(null)), table266, "And ");
#line hidden
            ...
            table267.AddRow(new string[] {
                        ...
                        "320"});
#line 545
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table267, "And ");
#line hidden
            ...
            table268.AddRow(new string[] {
                        ...
                        "1000002"});
#line 719
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table268, "And ");
#line 732
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 734
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                        "", providerVersionId), ((string)(null)), table269, "And ");
#line 747
...
#line 749
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                        "", providerVersionId), ((string)(null)), table270, "And ");
#line hidden
            ...
            table271.AddRow(new string[] {
                        ...
                        "Approved"});
#line 762
 testRunner.And(string.Format("calculation meta data exists for \'{0}\'", fundingStreamId), ((string)(null)), table271, "And ");
#line hidden
            ...
            table272.AddRow(new string[] {
                        ...
                        "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 936
 testRunner.And("calculations exists", ((string)(null)), table272, "And ");
#line hidden
            ...
            table273.AddRow(new string[] {
                        ...
                        "2000"});
#line 1110
 testRunner.And("the following distribution periods exist", ((string)(null)), table273, "And ");
#line hidden
            ...
            table274.AddRow(new string[] {
                        ...
                        "2000"});
#line 1114
 testRunner.And("the following profiles exist", ((string)(null)), table274, "And ");
#line 1118
...
#line hidden
            ...
            table275.AddRow(new string[] {
                        ...
                        "Updated"});
#line 1119
 testRunner.Then("the following published provider ids are upserted", ((string)(null)), table275, "Then ");
#line hidden
