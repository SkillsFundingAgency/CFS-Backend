...
#line hidden
            ...
            else
            {
                ...
                table157.AddRow(new string[] {
                            ...
                            "1.0"});
#line 7
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table157, "Given ");
#line hidden
                ...
                table158.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 10
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table158, "And ");
#line hidden
#line 16
...
#line hidden
                ...
                table159.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 17
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table159, "And ");
#line hidden
#line 23
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 24
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table160, "And ");
#line hidden
#line 30
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 31
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table161, "And ");
#line hidden
#line 37
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table162.AddRow(new string[] {
                            ...
                            "Country"});
#line 38
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table162, "And ");
#line hidden
#line 44
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table163.AddRow(new string[] {
                            ...
                            "AC"});
#line 45
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table163, "And ");
#line hidden
...
#line 53
 testRunner.And("the following specification exists", ((string)(null)), table164, "And ");
#line hidden
#line 59
...
#line 60
 testRunner.And("the specification has the following funding streams", ((string)(null)), table165, "And ");
#line hidden
                ...
                table166.AddRow(new string[] {
                            ...
                            "1.0"});
#line 63
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table166, "And ");
#line hidden
                ...
                table167.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 66
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table167, "And ");
#line hidden
                ...
                table168.AddRow(new string[] {
                            ...
                            ""});
#line 71
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table168, "And ");
#line hidden
#line 77
...
#line hidden
                ...
                table169.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 78
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table169, "And ");
#line hidden
...
#line 120
 testRunner.And("template mapping exists", ((string)(null)), table172, "And ");
#line hidden
...
#line 284
 testRunner.And("the Published Provider has the following distribution period for funding line \'GA" +
                        "G-002\'", ((string)(null)), table173, "And ");
#line hidden
...
#line 288
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'GAG-002\'", ((string)(null)), table174, "And ");
#line hidden
...
#line 592
 testRunner.And("the Published Provider has the following distribution period for funding line \'GA" +
                        "G-002\'", ((string)(null)), table180, "And ");
#line hidden
...
#line 596
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'GAG-002\'", ((string)(null)), table181, "And ");
#line hidden
...
#line 817
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table184, "And ");
#line hidden
#line 868
...
#line 870
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table185, "And ");
#line hidden
                ...
                table186.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 921
 testRunner.And("calculations exists", ((string)(null)), table186, "And ");
#line hidden
                ...
                table187.AddRow(new string[] {
                            "1000002"});
#line 1095
 testRunner.When("partial funding is approved", ((string)(null)), table187, "When ");
#line hidden
                ...
                table188.AddRow(new string[] {
                            ...
                            "Approved"});
#line 1098
 testRunner.Then("the following published provider ids are upserted", ((string)(null)), table188, "Then ");
#line hidden
...
#line 1102
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table189, "And ");
#line hidden
            }
