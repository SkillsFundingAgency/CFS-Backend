...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "ApproveBatchFundingGag", "\tIn order to approve funding for GAG\r\n\tAs a funding approver\r\n\tI want to approve " +
        ...
        public virtual void TestInitialize()
        {
            ...
            {
                global::CalculateFunding.Publishing.AcceptanceTests.Features.ApproveBatchFundingGagFeature.FeatureSetup(null);
            }
        }
...
#line hidden
                ...
                table206.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 17
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table206, "And ");
#line hidden
#line 23
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 31
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table208, "And ");
#line hidden
#line 37
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table210.AddRow(new string[] {
                            ...
                            "AC"});
#line 45
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table210, "And ");
#line hidden
...
#line 53
 testRunner.And("the following specification exists", ((string)(null)), table211, "And ");
#line hidden
#line 59
...
#line 60
 testRunner.And("the specification has the following funding streams", ((string)(null)), table212, "And ");
#line hidden
                ...
                table213.AddRow(new string[] {
                            ...
                            "1.2"});
#line 63
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table213, "And ");
#line hidden
                ...
                table214.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 66
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table214, "And ");
#line hidden
                ...
                table215.AddRow(new string[] {
                            ...
                            ""});
#line 71
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table215, "And ");
#line hidden
#line 77
...
#line hidden
                ...
                table216.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 78
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table216, "And ");
#line hidden
...
#line 88
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table217, "And ");
#line hidden
                ...
                table218.AddRow(new string[] {
                            ...
                            "Information"});
#line 99
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table218, "And ");
#line hidden
...
#line 230
 testRunner.And("template mapping exists", ((string)(null)), table219, "And ");
#line hidden
...
#line 394
 testRunner.And("the Published Provider has the following distribution period for funding line \'GA" +
                        "G-002\'", ((string)(null)), table220, "And ");
#line hidden
...
#line 398
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'GAG-002\'", ((string)(null)), table221, "And ");
#line hidden
...
#line 619
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table224, "And ");
#line hidden
#line 670
...
#line 812
 testRunner.And("the Published Provider has the following distribution period for funding line \'GA" +
                        "G-002\'", ((string)(null)), table227, "And ");
#line hidden
...
#line 816
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'GAG-002\'", ((string)(null)), table228, "And ");
#line hidden
...
#line 1037
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table231, "And ");
#line hidden
#line 1088
...
#line 1090
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table232, "And ");
#line hidden
                ...
                table233.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 1141
 testRunner.And("calculations exists", ((string)(null)), table233, "And ");
#line hidden
                ...
                table234.AddRow(new string[] {
                            "1000002"});
#line 1315
 testRunner.When("partial funding is approved", ((string)(null)), table234, "When ");
#line hidden
                ...
                table235.AddRow(new string[] {
                            ...
                            "Approved"});
#line 1318
 testRunner.Then("the following published provider ids are upserted", ((string)(null)), table235, "Then ");
#line hidden
...
#line 1322
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table236, "And ");
#line hidden
            }
