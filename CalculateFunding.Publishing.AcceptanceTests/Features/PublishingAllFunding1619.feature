...
Scenario Outline: Successful publishing of funding
	...
	Then the following published funding is produced
		...
		| FundingPeriodId                  | <FundingPeriodId> |
		| FundingStreamId                  | <FundingStreamId> |
	And the total funding is '1132761.64'
	...
	And the published funding contains a distribution period in funding line '1619-001' with id of 'AS-1920' has the value of '14000'
	And the published funding contains a distribution period in funding line '1619-001' with id of 'AS-2021' has the value of '1132761.64'
	And the published funding contains a distribution period in funding line '1619-001' with id of 'AS-1920' has the following profiles
		| DistributionPeriodId | Type          | TypeValue | Year | Occurrence | ProfiledValue |
		| AS-1920              | CalendarMonth | October   | 1920 | 1          | 14000         |
	And the published funding contains a distribution period in funding line '1619-001' with id of 'AS-2021' has the following profiles
		| DistributionPeriodId | Type          | TypeValue | Year | Occurrence | ProfiledValue |
		| AS-2021              | CalendarMonth | April     | 2021 | 1          | 1132761.64    |
	...
	And the following published provider search index items is produced for providerid with '<FundingStreamId>' and '<FundingPeriodId>'
		...
		| 1619-AS-2021-1000002 | Acade        | FSAP            | Local Authority 1 | Released      | Academy 2    | 1000002 | 566380.82    | specForPublishing | <FundingStreamId> | <FundingPeriodId> |        | Hide indicative allocations | 1				| 0				|
