...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "ApproveBatchFundingDsg", "\tIn order to approve funding for DSG\r\n\tAs a funding approver\r\n\tI want to approve " +
...
#line hidden
            ...
            else
            {
                ...
                table171.AddRow(new string[] {
                            ...
                            "1.0"});
#line 7
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table171, "Given ");
#line hidden
...
#line hidden
                ...
                table173.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 17
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table173, "And ");
#line hidden
#line 23
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 31
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table175, "And ");
#line hidden
#line 37
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 120
 testRunner.And("template mapping exists", ((string)(null)), table186, "And ");
#line hidden
...
#line 284
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table187, "And ");
#line hidden
...
#line 288
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table188, "And ");
#line hidden
                ...
                table189.AddRow(new string[] {
                            ...
                            "320"});
#line 292
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table189, "And ");
#line hidden
                ...
                table190.AddRow(new string[] {
                            ...
                            ""});
#line 456
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table190, "And ");
#line hidden
#line 507
...
#line 509
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table191, "And ");
#line hidden
#line 560
...
#line 561
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table192, "And ");
#line hidden
                ...
                table193.AddRow(new string[] {
                            ...
                            "Payment"});
#line 571
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table193, "And ");
#line hidden
...
#line 592
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table194, "And ");
#line hidden
...
#line 596
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table195, "And ");
#line hidden
                ...
                table196.AddRow(new string[] {
                            ...
                            "320"});
#line 600
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table196, "And ");
#line hidden
                ...
                table197.AddRow(new string[] {
                            ...
                            ""});
#line 764
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table197, "And ");
#line hidden
#line 815
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table200.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 921
 testRunner.And("calculations exists", ((string)(null)), table200, "And ");
#line hidden
                ...
                table201.AddRow(new string[] {
                            "1000002"});
#line 1095
 testRunner.When("partial funding is approved", ((string)(null)), table201, "When ");
#line hidden
                ...
                table202.AddRow(new string[] {
                            ...
                            "Approved"});
#line 1098
 testRunner.Then("the following published provider ids are upserted", ((string)(null)), table202, "Then ");
#line hidden
...
#line 1102
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table203, "And ");
#line hidden
            }
