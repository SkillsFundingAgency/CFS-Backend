...
#line hidden
            ...
            else
            {
                ...
                table449.AddRow(new string[] {
                            ...
                            "1.0"});
#line 7
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table449, "Given ");
#line hidden
                ...
                table450.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 10
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table450, "And ");
#line hidden
#line 16
...
#line 31
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table453, "And ");
#line hidden
#line 37
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table455.AddRow(new string[] {
                            ...
                            "FY"});
#line 45
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table455, "And ");
#line hidden
...
#line 53
 testRunner.And("the following specification exists", ((string)(null)), table456, "And ");
#line hidden
#line 59
...
#line 60
 testRunner.And("the specification has the following funding streams", ((string)(null)), table457, "And ");
#line hidden
                ...
                table458.AddRow(new string[] {
                            ...
                            "1.0"});
#line 63
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table458, "And ");
#line hidden
                ...
                table459.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 66
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table459, "And ");
#line hidden
                ...
                table460.AddRow(new string[] {
                            ...
                            ""});
#line 71
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table460, "And ");
#line hidden
#line 77
...
#line hidden
                ...
                table461.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 78
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table461, "And ");
#line hidden
...
#line 89
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table462, "And ");
#line hidden
                ...
                table463.AddRow(new string[] {
                            ...
                            "Payment"});
#line 99
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table463, "And ");
#line hidden
...
#line 122
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table464, "And ");
#line hidden
...
#line 126
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table465, "And ");
#line hidden
...
#line 130
 testRunner.And("template mapping exists", ((string)(null)), table466, "And ");
#line hidden
                ...
                table467.AddRow(new string[] {
                            ...
                            "320"});
#line 304
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table467, "And ");
#line hidden
                ...
                table468.AddRow(new string[] {
                            ...
                            "1000000"});
#line 478
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table468, "And ");
#line hidden
#line 491
...
#line 507
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table470, "And ");
#line hidden
                ...
                table471.AddRow(new string[] {
                            ...
                            "Payment"});
#line 517
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table471, "And ");
#line hidden
...
#line 540
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table472, "And ");
#line hidden
...
#line 544
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table473, "And ");
#line hidden
                ...
                table474.AddRow(new string[] {
                            ...
                            "320"});
#line 548
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table474, "And ");
#line hidden
                ...
                table475.AddRow(new string[] {
                            ...
                            "1000002"});
#line 722
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table475, "And ");
#line hidden
#line 735
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 737
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table476, "And ");
#line hidden
#line 750
...
#line 752
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table477, "And ");
#line hidden
                ...
                table478.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 765
 testRunner.And("calculations exists", ((string)(null)), table478, "And ");
#line hidden
...
#line 939
 testRunner.When("batch funding is published", ((string)(null)), table479, "When ");
#line hidden
                ...
                table480.AddRow(new string[] {
                            ...
                            string.Format("{0}", fundingStreamId)});
#line 942
 testRunner.Then("the following published funding is produced", ((string)(null)), table480, "Then ");
#line hidden
#line 949
...
#line 950
 testRunner.And("the published funding contains the following published provider ids", ((string)(null)), table481, "And ");
#line hidden
#line 954
...
#line 956
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-1920\' has the following profiles", ((string)(null)), table482, "And ");
#line hidden
...
#line 959
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-2021\' has the following profiles", ((string)(null)), table483, "And ");
#line hidden
...
#line 962
 testRunner.And("the published funding contains a calculations in published provider with followin" +
                        "g calculation results", ((string)(null)), table484, "And ");
#line hidden
...
#line 1074
 testRunner.And("the published funding document produced is saved to blob storage for following fi" +
                        "le name", ((string)(null)), table485, "And ");
#line hidden
                ...
                table486.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1078
 testRunner.And("the published funding document produced has following metadata", ((string)(null)), table486, "And ");
#line hidden
...
#line 1082
 testRunner.And("the published provider document produced is saved to blob storage for following f" +
                        "ile name", ((string)(null)), table487, "And ");
#line hidden
                ...
                table488.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1085
 testRunner.And("the published provider document produced has following metadata", ((string)(null)), table488, "And ");
#line hidden
...
#line 1088
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table489, "And ");
#line hidden
                ...
                table490.AddRow(new string[] {
                            ...
                            ""});
#line 1091
 testRunner.And("the following job is requested is completed for the current specification", ((string)(null)), table490, "And ");
#line hidden
                ...
                table491.AddRow(new string[] {
                            ...
                            "Released"});
#line 1097
 testRunner.And("the following released published provider ids are upserted", ((string)(null)), table491, "And ");
#line hidden
            }
