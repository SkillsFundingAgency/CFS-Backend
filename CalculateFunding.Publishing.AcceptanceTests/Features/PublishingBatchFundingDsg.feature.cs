...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "PublishingBatchFundingDsg", "\tIn order to publish funding for Dedicated Schools Grant\r\n\tAs a funding approvder" +
        ...
        public virtual void TestInitialize()
        {
            ...
            {
                global::CalculateFunding.Publishing.AcceptanceTests.Features.PublishingBatchFundingDsgFeature.FeatureSetup(null);
            }
        }
...
#line hidden
            ...
            else
            {
                ...
                table582.AddRow(new string[] {
                            ...
                            "1.0"});
#line 7
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table582, "Given ");
#line hidden
...
#line hidden
                ...
                table584.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 17
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table584, "And ");
#line hidden
#line 23
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 24
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table585, "And ");
#line hidden
#line 30
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 31
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table586, "And ");
#line hidden
#line 37
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table587.AddRow(new string[] {
                            ...
                            "Country"});
#line 38
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table587, "And ");
#line hidden
#line 44
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table588.AddRow(new string[] {
                            ...
                            "FY"});
#line 45
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table588, "And ");
#line hidden
...
#line 53
 testRunner.And("the following specification exists", ((string)(null)), table589, "And ");
#line hidden
#line 59
...
#line 60
 testRunner.And("the specification has the following funding streams", ((string)(null)), table590, "And ");
#line hidden
                ...
                table591.AddRow(new string[] {
                            ...
                            "1.0"});
#line 63
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table591, "And ");
#line hidden
                ...
                table592.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 66
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table592, "And ");
#line hidden
                ...
                table593.AddRow(new string[] {
                            ...
                            ""});
#line 71
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table593, "And ");
#line hidden
#line 77
...
#line hidden
                ...
                table594.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 78
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table594, "And ");
#line hidden
...
#line 122
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table597, "And ");
#line hidden
...
#line 126
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table598, "And ");
#line hidden
...
#line 130
 testRunner.And("template mapping exists", ((string)(null)), table599, "And ");
#line hidden
...
#line 507
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table603, "And ");
#line hidden
                ...
                table604.AddRow(new string[] {
                            ...
                            "Payment"});
#line 517
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table604, "And ");
#line hidden
...
#line 540
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table605, "And ");
#line hidden
...
#line 544
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table606, "And ");
#line hidden
                ...
                table607.AddRow(new string[] {
                            ...
                            "320"});
#line 548
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table607, "And ");
#line hidden
                ...
                table608.AddRow(new string[] {
                            ...
                            "1000002"});
#line 722
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table608, "And ");
#line hidden
#line 735
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 737
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table609, "And ");
#line hidden
#line 750
...
#line 752
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table610, "And ");
#line hidden
...
#line 939
 testRunner.When("batch funding is published", ((string)(null)), table612, "When ");
#line hidden
                ...
                table613.AddRow(new string[] {
                            ...
                            string.Format("{0}", fundingStreamId)});
#line 942
 testRunner.Then("the following published funding is produced", ((string)(null)), table613, "Then ");
#line hidden
#line 949
...
#line 950
 testRunner.And("the published funding contains the following published provider ids", ((string)(null)), table614, "And ");
#line hidden
#line 954
...
#line 956
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-1920\' has the following profiles", ((string)(null)), table615, "And ");
#line hidden
...
#line 959
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-2021\' has the following profiles", ((string)(null)), table616, "And ");
#line hidden
...
#line 962
 testRunner.And("the published funding contains a calculations in published provider with followin" +
                        "g calculation results", ((string)(null)), table617, "And ");
#line hidden
...
#line 1074
 testRunner.And("the published funding document produced is saved to blob storage for following fi" +
                        "le name", ((string)(null)), table618, "And ");
#line hidden
                ...
                table619.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1078
 testRunner.And("the published funding document produced has following metadata", ((string)(null)), table619, "And ");
#line hidden
...
#line 1082
 testRunner.And("the published provider document produced is saved to blob storage for following f" +
                        "ile name", ((string)(null)), table620, "And ");
#line hidden
                ...
                table621.AddRow(new string[] {
                            ...
                            "specForPublishing"});
#line 1085
 testRunner.And("the published provider document produced has following metadata", ((string)(null)), table621, "And ");
#line hidden
...
#line 1088
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table622, "And ");
#line hidden
                ...
                table623.AddRow(new string[] {
                            ...
                            ""});
#line 1091
 testRunner.And("the following job is requested is completed for the current specification", ((string)(null)), table623, "And ");
#line hidden
                ...
                table624.AddRow(new string[] {
                            ...
                            "Released"});
#line 1097
 testRunner.And("the following released published provider ids are upserted", ((string)(null)), table624, "And ");
#line hidden
            }
