...
#line hidden
            ...
            else
            {
                ...
                table353.AddRow(new string[] {
                            ...
                            "1.0"});
#line 7
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table353, "Given ");
#line hidden
                ...
                table354.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 10
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table354, "And ");
#line hidden
#line 16
...
#line hidden
                ...
                table359.AddRow(new string[] {
                            ...
                            "FY"});
#line 45
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table359, "And ");
#line hidden
...
#line 53
 testRunner.And("the following specification exists", ((string)(null)), table360, "And ");
#line hidden
#line 59
...
#line 60
 testRunner.And("the specification has the following funding streams", ((string)(null)), table361, "And ");
#line hidden
                ...
                table362.AddRow(new string[] {
                            ...
                            "1.0"});
#line 63
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table362, "And ");
#line hidden
                ...
                table363.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 66
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table363, "And ");
#line hidden
                ...
                table364.AddRow(new string[] {
                            ...
                            ""});
#line 71
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table364, "And ");
#line hidden
#line 77
...
#line hidden
                ...
                table365.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 78
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table365, "And ");
#line hidden
...
#line 122
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table368, "And ");
#line hidden
...
#line 126
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table369, "And ");
#line hidden
...
#line 130
 testRunner.And("template mapping exists", ((string)(null)), table370, "And ");
#line hidden
                ...
                table371.AddRow(new string[] {
                            ...
                            "320"});
#line 305
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table371, "And ");
#line hidden
                ...
                table372.AddRow(new string[] {
                            ...
                            "1000000"});
#line 479
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table372, "And ");
#line hidden
#line 492
...
#line 494
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table373, "And ");
#line hidden
#line 507
...
#line 508
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table374, "And ");
#line hidden
                ...
                table375.AddRow(new string[] {
                            ...
                            "Payment"});
#line 518
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table375, "And ");
#line hidden
...
#line 541
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table376, "And ");
#line hidden
...
#line 545
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table377, "And ");
#line hidden
                ...
                table378.AddRow(new string[] {
                            ...
                            "320"});
#line 549
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table378, "And ");
#line hidden
                ...
                table379.AddRow(new string[] {
                            ...
                            "1000002"});
#line 723
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table379, "And ");
#line hidden
#line 736
 testRunner.And("the Published Provider is available in the repository for this specification", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 738
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table380, "And ");
#line hidden
#line 752
...
#line 754
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table381, "And ");
#line hidden
                ...
                table382.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 767
 testRunner.And("calculations exists", ((string)(null)), table382, "And ");
#line hidden
                ...
                table383.AddRow(new string[] {
                            "1000000"});
#line 941
 testRunner.When("batch funding is published", ((string)(null)), table383, "When ");
#line hidden
