...
#line hidden
            ...
            else
            {
                ...
                table355.AddRow(new string[] {
                            ...
                            "1.0"});
#line 7
 testRunner.Given(string.Format("a funding configuration exists for funding stream \'{0}\' in funding period \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table355, "Given ");
#line hidden
                ...
                table356.AddRow(new string[] {
                            ...
                            "LocalAuthority"});
#line 10
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table356, "And ");
#line hidden
#line 16
...
#line 24
 testRunner.And("the funding configuration has the following organisation group", ((string)(null)), table358, "And ");
#line hidden
#line 30
 testRunner.And("the funding configuration is available in the policies repository", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table361.AddRow(new string[] {
                            ...
                            "FY"});
#line 45
 testRunner.And("the funding period exists in the policies service", ((string)(null)), table361, "And ");
#line hidden
...
#line 53
 testRunner.And("the following specification exists", ((string)(null)), table362, "And ");
#line hidden
#line 59
...
#line 60
 testRunner.And("the specification has the following funding streams", ((string)(null)), table363, "And ");
#line hidden
                ...
                table364.AddRow(new string[] {
                            ...
                            "1.0"});
#line 63
 testRunner.And("the specification has the following template versions for funding streams", ((string)(null)), table364, "And ");
#line hidden
                ...
                table365.AddRow(new string[] {
                            ...
                            "2019-09-29 00:00:00"});
#line 66
 testRunner.And("the publishing dates for the specifcation are set as following", ((string)(null)), table365, "And ");
#line hidden
                ...
                table366.AddRow(new string[] {
                            ...
                            ""});
#line 71
 testRunner.And("the following job is requested to be queued for the current specification", ((string)(null)), table366, "And ");
#line hidden
#line 77
...
#line hidden
                ...
                table367.AddRow(new string[] {
                            ...
                            "2019-12-11 00:00"});
#line 78
 testRunner.And("the following provider version exists in the providers service", ((string)(null)), table367, "And ");
#line hidden
...
#line 89
 testRunner.And("the following Published Provider has been previously generated for the current sp" +
                        "ecification", ((string)(null)), table368, "And ");
#line hidden
                ...
                table369.AddRow(new string[] {
                            ...
                            "Payment"});
#line 99
 testRunner.And("the Published Provider has the following funding lines", ((string)(null)), table369, "And ");
#line hidden
...
#line 122
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table370, "And ");
#line hidden
...
#line 126
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table371, "And ");
#line hidden
...
#line 130
 testRunner.And("template mapping exists", ((string)(null)), table372, "And ");
#line hidden
                ...
                table373.AddRow(new string[] {
                            ...
                            "320"});
#line 305
 testRunner.And("the Published Provider contains the following calculation results", ((string)(null)), table373, "And ");
#line hidden
                ...
                table374.AddRow(new string[] {
                            ...
                            "1000000"});
#line 479
 testRunner.And("the Published Provider has the following provider information", ((string)(null)), table374, "And ");
#line hidden
#line 492
...
#line 494
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table375, "And ");
#line hidden
#line 507
...
#line 541
 testRunner.And("the Published Provider has the following distribution period for funding line \'DS" +
                        "G-002\'", ((string)(null)), table378, "And ");
#line hidden
...
#line 545
 testRunner.And("the Published Providers distribution period has the following profiles for fundin" +
                        "g line \'DSG-002\'", ((string)(null)), table379, "And ");
#line hidden
...
#line 738
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table382, "And ");
#line hidden
#line 752
...
#line 754
 testRunner.And(string.Format("the following provider exists within core provider data in provider version \'{0}\'" +
                            "", providerVersionId), ((string)(null)), table383, "And ");
#line hidden
                ...
                table384.AddRow(new string[] {
                            ...
                            "5cfb28de-88d6-4faa-a936-d81a065fb596"});
#line 767
 testRunner.And("calculations exists", ((string)(null)), table384, "And ");
#line hidden
                ...
                table385.AddRow(new string[] {
                            "1000000"});
#line 941
 testRunner.When("batch funding is published", ((string)(null)), table385, "When ");
#line hidden
                ...
                table386.AddRow(new string[] {
                            ...
                            string.Format("{0}", fundingStreamId)});
#line 944
 testRunner.Then("the following published funding is produced", ((string)(null)), table386, "Then ");
#line hidden
#line 951
...
#line 952
 testRunner.And("the published funding contains the following published provider ids", ((string)(null)), table387, "And ");
#line hidden
#line 956
...
#line 958
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-1920\' has the following profiles", ((string)(null)), table388, "And ");
#line hidden
...
#line 961
 testRunner.And("the published funding contains a distribution period in funding line \'DSG-002\' wi" +
                        "th id of \'FY-2021\' has the following profiles", ((string)(null)), table389, "And ");
#line hidden
...
#line 964
 testRunner.And("the published funding contains a calculations in published provider with followin" +
                        "g calculation results", ((string)(null)), table390, "And ");
#line hidden
...
#line 1076
 testRunner.And("the published funding document produced is saved to blob storage for following fi" +
                        "le name", ((string)(null)), table391, "And ");
#line hidden
...
#line 1080
 testRunner.And("the published provider document produced is saved to blob storage for following f" +
                        "ile name", ((string)(null)), table392, "And ");
#line hidden
...
#line 1083
 testRunner.And(string.Format("the following published provider search index items is produced for providerid wi" +
                            "th \'{0}\' and \'{1}\'", fundingStreamId, fundingPeriodId), ((string)(null)), table393, "And ");
#line hidden
                ...
                table394.AddRow(new string[] {
                            ...
                            ""});
#line 1086
 testRunner.And("the following job is requested is completed for the current specification", ((string)(null)), table394, "And ");
#line hidden
                ...
                table395.AddRow(new string[] {
                            ...
                            "Approved"});
#line 1092
 testRunner.And("the following released published provider ids are upserted", ((string)(null)), table395, "And ");
#line hidden
            }
