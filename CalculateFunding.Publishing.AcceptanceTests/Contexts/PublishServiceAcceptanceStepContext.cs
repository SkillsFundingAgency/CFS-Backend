...
namespace CalculateFunding.Publishing.AcceptanceTests.Contexts
{
    public class PublishServiceAcceptanceStepContext : IPublishFundingStepContext
    {
        ...
        public async Task ApproveResults(string specificationId, string jobId, string userId, string userName)
        {
            ResiliencePolicies resiliencePolicies = new ResiliencePolicies()
            {
                BlobClient = Policy.NoOpAsync(),
            ...
            await approveService.ApproveResults(message);
        }
        ...
        public bool ApproveFundingSuccessful { get; set; }
    }
}
