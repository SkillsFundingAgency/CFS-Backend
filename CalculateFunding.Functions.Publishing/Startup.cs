    ...
    public class Startup : FunctionsStartup
    {
            ...
            IConfigurationRoot config)
        {
            ...
            builder.AddScoped<IPublishingDataTableImporter, ReleasedDataTableImporter>((ctx) =>
            {
                ...
                config.Bind("releasedSql", sqlSettings);
            ...
            builder.AddTransient<IDetectPublishedProviderErrors, ProviderNotMemberOfOrganisationGroupErrorDetector>();
            ...
            builder.AddTransient<IDetectPublishedProviderErrors, CarryOverAmountFoundErrorDetector>();
        ...
        private static ResiliencePolicies CreateResiliencePolicies(PolicySettings policySettings)
        {
            ...
            ResiliencePolicies resiliencePolicies = new ResiliencePolicies
            {
                ...
                PublishedIndexSearchResiliencePolicy = SearchResiliencePolicyHelper.GenerateSearchPolicy(totalNetworkRequestsPolicy),
