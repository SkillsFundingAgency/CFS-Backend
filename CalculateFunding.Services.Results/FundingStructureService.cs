...
using FundingStructure = CalculateFunding.Models.Result.FundingStructure;
using FundingStructureItem = CalculateFunding.Models.Result.FundingStructureItem;
using FundingStructureType = CalculateFunding.Models.Result.FundingStructureType;
