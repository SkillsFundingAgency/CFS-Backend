...
namespace CalculateFunding.Api.Publishing.IntegrationTests.RefreshFunding
{
    public class SpecificationTemplateParametersBuilder : TestEntityBuilder
    {
        ...
        private ProfileVariationPointer[] _profileVariationPointers;
        ...
        public SpecificationTemplateParametersBuilder WithProfileVariationPointers(params ProfileVariationPointer[] profileVariationPointers)
        {
            _profileVariationPointers = profileVariationPointers;
        ...
        public SpecificationTemplateParameters Build() =>
            new SpecificationTemplateParameters
            {
                ...
                DataDefinitionRelationshipIds = _dataDefinitionRelationshipIds ?? Array.Empty<string>(),
                IsSelectedForFunding = _isSelectedForFunding ?? false,
                ProfileVariationPointers = _profileVariationPointers ?? Array.Empty<ProfileVariationPointer>()
            };
    }
}