...
namespace CalculateFunding.Repositories.Providers
{
    ...
    public sealed class EdubaseRecordMap : ClassMap<ProviderBaseEntity>
    {
        public EdubaseRecordMap()
        {
            ...
            Map(m => m.EstablishmentType).Name("TypeOfEstablishment (name)");
            //Map(m => m.EstablishmentTypeGroup.Id).Name("EstablishmentTypeGroup (code)");
            Map(m => m.EstablishmentTypeGroup).Name("EstablishmentTypeGroup (name)");
            //Map(m => m.EstablishmentStatus.Id).Name("EstablishmentStatus (code)");
            Map(m => m.EstablishmentStatus).Name("EstablishmentStatus (name)");
           // Map(m => m.ReasonEstablishmentOpened.Id).Name("ReasonEstablishmentOpened (code)");
            Map(m => m.ReasonEstablishmentOpened).Name("ReasonEstablishmentOpened (name)");
            ...
            Map(m => m.ReasonEstablishmentClosed).Name("ReasonEstablishmentClosed (name)");
            Map(m => m.CloseDate).ConvertUsing(m => MapToDate(m, "CloseDate"));
           // Map(m => m.PhaseOfEducation.Id).Name("PhaseOfEducation (code)");
            Map(m => m.PhaseOfEducation).Name("PhaseOfEducation (name)");
         ...
         //   Map(m => m.AdmissionsPolicy.Id).Name("AdmissionsPolicy (code)");
          ...
          //  Map(m => m.SpecialClasses.Id).Name("Diocese (code)");
           ...
           // Map(m => m.Federations.Id).Name("Trusts (code)");
            Map(m => m.Federations).Name("Trusts (name)");
           ...
           // Map(m => m.OfstedSpecialMeasures.Id).Name("OfstedSpecialMeasures (code)");
            Map(m => m.OfstedSpecialMeasures).Name("OfstedSpecialMeasures (name)");
           ...
           // Map(m => m.GOR.Id).Name("GOR (code)");
            Map(m => m.GOR).Name("GOR (name)");

          //  Map(m => m.DistrictAdministrative.Id).Name("DistrictAdministrative (code)");
            Map(m => m.DistrictAdministrative).Name("DistrictAdministrative (name)");

          //  Map(m => m.AdministrativeWard.Id).Name("AdministrativeWard (code)");
            Map(m => m.AdministrativeWard).Name("AdministrativeWard (name)");

          //  Map(m => m.ParliamentaryConstituency.Id).Name("ParliamentaryConstituency (code)");
            Map(m => m.ParliamentaryConstituency).Name("ParliamentaryConstituency (name)");

          //  Map(m => m.UrbanRural.Id).Name("ParliamentaryConstituency (code)");
            Map(m => m.UrbanRural).Name("ParliamentaryConstituency (name)");
